  ...
  return (
    <div className='w-full h-full overflow-y-hidden pb-36'>
      <div className='flex flex-col items-center overflow-y-hidden w-full h-full justify-center gap-y-6'>
        ...
        <button onClick={resetHandler} className='bg-slate-200 hover:bg-slate-100 hover:transition-all hover:duration-200 flex justify-center items-center h-[10%] w-[13%] rounded-lg'>Refresh</button>
      </div>
    </div>
  );
};
